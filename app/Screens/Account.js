...
export default function Account() {
  return (
    <View style={styles.container}>
      ...
      <View>
        <CustomSearch placeholder={"Bạn muốn tìm gì"}/>
      </View>

      <View>
        <CustomFooter_Product/>
        {/* <CustomFooter_Home/>
        <CustomFooter_Account/>
        <CustomFooter_Notification/> */}
      </View>
      <Pressable onPress={()=>navigation.navigate('Payment')}><Text>Payment</Text></Pressable>
    </View>
  );
}
