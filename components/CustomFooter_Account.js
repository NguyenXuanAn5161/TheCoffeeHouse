...
const CustomFooter_Account = ({navigation,onPress}) => (
  <View>
      ...
      <View style={styles.footer2}>
        ...
        <Pressable style={styles.btn} onPress={()=>navigation.navigate('Account')}>
            <View style={styles.circle_footer}>
                <MaterialCommunityIcons name="account" size={40} color="#834637" style={{alignSelf:'center'}} />  
            </View>
...
export default CustomFooter_Account;
